...
load_dotenv("../../.env")  # Load environment variables from .env files
...
response1 = chain_with_history.invoke(
    {"input": "My name is Alice and I love Python"}, config
)
print(f"AI: {response1.content}")

response2 = chain_with_history.invoke(
    {"input": "What's my name and what do I love?"}, config
)
