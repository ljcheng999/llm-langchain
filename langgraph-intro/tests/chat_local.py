...
from src.misty.misty_graph import Agent
from src.misty.misty_intro import misty_system_prompt
...
def main():
    try:
        ...
        agent = Agent(
            name="Misty",
            system_prompt=misty_system_prompt,
...
if __name__ == "__main__":
    print(
        f"\nGreetings!\n\nTry asking Misty to show you a preview of the data.\n\n{40*"="}\n\n"
    )
